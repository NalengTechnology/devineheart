        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
            ...
            <a class="dropdown-item text-center small text-gray-500" href="feedback.php">Show All Comments</a>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Add program</h3>
                </div>
                <hr>
                                ...
                                <div class="card mb-5">
                                    ...
                                    ?>
                                        <form action="<?php $_PHP_SELF ?>" method="post">
                                            <div class="mb-3"><input class="form-control" type="text" id="name-2" name="title" placeholder="Program title" required="required-input"></div>
                                            <div class="mb-3"><textarea class="form-control" id="message-2" name="desc" rows="6" placeholder="Program Description" required="required"></textarea></div>
                                            <div><button name="submit_program" class="btn btn-primary d-block w-100" type="submit">Add </button></div><br>
                                            <div><button class="btn btn-primary d-block w-100" type="reset">Reset </button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © Devine Heart Orphanage 2023</span></div>
                </div>
            </footer>
