        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
            ...
            <a class="dropdown-item text-center small text-gray-500" href="feedback.php">Show All Comments</a>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Children <a href="children-add.php"><button style="margin-left: 60%; margin-bottom: 7px; font-size: 20px; border-radius: 5px; background-color: #4e73df;">Add Children </button></a></h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Children Information</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td><img class="rounded-circle me-2" width="30" height="30" src="assets/img/avatars/avatar1.jpeg"><?php echo $row['cname']; ?></td>
                                            <td><?php echo $formateddate; ?></td>
                                            <td><?php echo $row['cyoe']; ?></td>
                                            <td><?php echo $row['cclass']; ?></td> </tr>
                                                <?php
                                                 }
                                                }
                                            ?>
