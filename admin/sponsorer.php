        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
            ...
            <a class="dropdown-item text-center small text-gray-500" href="feedback.php">Show All Comments</a>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">sponsorer</h3>
                    <div class="card shadow">
                        ...
                        ?>
                                        <tr>
                                            <td><img class="rounded-circle me-2" width="30" height="30" src="assets/img/avatars/avatar3.jpeg"><?php echo $row['spn_firstname']; ?></td>
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © DevinE Heart Orphange 2023</span></div>
                </div>
            </footer>
